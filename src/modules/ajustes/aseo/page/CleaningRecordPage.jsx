    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F8FAFC] to-[#EEF2F7] p-8 max-w-6xl mx-auto space-y-12">
      ...
      <div className="bg-white p-8 rounded-3xl shadow-md border border-gray-100 space-y-6">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-2xl font-semibold transition shadow-sm"
        >
          Crear Limpieza
        </button>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {records.map((r) => (
            <div
              ...
              className={`cursor-pointer p-6 rounded-3xl border transition shadow-sm ${selectedRecord?.id === r.id
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`text-xs font-bold px-3 py-1 rounded-full ${r.status === "completed"
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 space-y-8">
          ...
          <div>
            ...
            <div className="mt-3 h-3 w-full bg-gray-200 rounded-full overflow-hidden">
              <div
                className={`h-full transition-all duration-500 ${percent === 100 ? "bg-green-600" : "bg-blue-500"
                  }`}
                style={{ width: `${percent}%` }}
              />
            </div>
          ...
          {selectedRecord.status === "completed" ? (
            ...
            <>
              ...
              <button
                ...
                className={`w-full py-3 rounded-2xl font-bold transition ${percent === 100 && observationText.trim()
